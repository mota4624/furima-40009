class OrderAddress
  ...
  with_options presence: true do
    ...
    validates :user_id, :item_id, :city, :housenumber, :token
  end
  ...
  def save
    ...
    # 発送先情報を保存する
    Address.create(postalcode: postalcode, prefecture: prefecture, city: city, housenumber: housenumber, building: building, phone: phone, order_id: order.id)
  end
